...
foreach($db->query(
   "SELECT id, checked, if(rawReceipt is Null or rawReceipt='', '0', '1') rawLoaded, if(exists(SELECT 1 FROM ".DB_TABLE_PREFIX."receipt_user u where u.user_id=r.user_id),1,0) u_acc_exists
