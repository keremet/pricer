...
$stmt = $db->prepare("INSERT INTO pr_consumption (prof_el,price,creator,date_buy) VALUES (?,?,?,?)"); 
if(!$stmt->execute(array($_REQUEST['product_id'], $price, $_SESSION['user']['id'], $date_buy))){
